...
| Tests | **485** passing (**492** collected), 7 skipped optional (1 SBERT + 6 Postgres CI); 100% accuracy on 5 benchmark scenarios |
...
└── tests/            # 492 tests collected (incl. adversarial + fuzz + agent CLI suite)
...
**Tests: 492** collected (**485** passed in a local run on 2026-06-10; 7 skipped optional: 1 SBERT, 6 Postgres CI). See [Related Projects](#related-projects) for the separate CPX52 V2.0 stack scope.
